...
def acs_pull(word):
    ...
    if not os.path.isfile('C:\\Users\\robsc\\Desktop\\Github Desktop\\American-Communities-Survey\\insurancedata.csv'):
        insur.to_csv('C:\\Users\\robsc\\Desktop\\Github Desktop\\American-Communities-Survey\\insurancedata.csv', index= True, header='headers' )
    else:
        insur.to_csv('C:\\Users\\robsc\\Desktop\\Github Desktop\\American-Communities-Survey\\insurancedata.csv', mode= 'a' , header=False )
